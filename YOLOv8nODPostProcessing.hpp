...
#define YOLOV8N_OD_STRIDE16_CONFIDENCE_TENSOR_INDEX	(1)		//[1, 144, 1]
#define YOLOV8N_OD_STRIDE32_CONFIDENCE_TENSOR_INDEX	(2)		//[1, 36, 1]

#define YOLOV8N_OD_STRIDE8_BOX_TENSOR_INDEX		(4)		//[1, 576, 64]
#define YOLOV8N_OD_STRIDE16_BOX_TENSOR_INDEX	(3)		//[1, 144, 64]
#define YOLOV8N_OD_STRIDE32_BOX_TENSOR_INDEX	(0)		//[1, 36, 64]
